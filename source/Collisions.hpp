    ...
    for (int i = 0; i < atom.collisions.extent(0); ++i) {
        ...
        switch (coll.type) {
            case CollRateType::Omega: {
                collision_omega(atmos, atom, coll, C, n_star, x, y);
            } break;
            case CollRateType::CI: {
                collision_ci(atmos, atom, coll, C, n_star, x, y);
            } break;
            case CollRateType::CE: {
                collision_ce(atmos, atom, coll, C, n_star, x, y);
            } break;
            case CollRateType::CP: {
                collision_cp(atmos, atom, coll, C, n_star, x, y);
            } break;
            case CollRateType::CH: {
                collision_ch(atmos, atom, coll, C, n_star, x, y);
            } break;
            case CollRateType::ChargeExcH: {
                collision_charge_exc_h(atmos, atom, coll, C, n_star, x, y);
            } break;
            case CollRateType::ChargeExcP: {
                collision_charge_exc_p(atmos, atom, coll, C, n_star, x, y);
            } break;
        }
    }
}
