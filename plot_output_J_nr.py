...
if __name__ == "__main__":
    ...
    ctx = lw.Context(atmos, spect, eq_pops, formalSolver="piecewise_linear_1d", Nthreads=12, conserveCharge=True, nrHOnly=True)
