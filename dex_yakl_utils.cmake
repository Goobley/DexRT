...
macro(yakl_process_cxx_source_files files)
  ...
  if ("${YAKL_ARCH}" STREQUAL "CUDA")
    if( ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "NVHPC")  OR  ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "PGI") )
      ...
      set_source_files_properties(${files} PROPERTIES CUDA_STANDARD 20)
      set(YAKL_COMPILER_FLAGS "-DYAKL_ARCH_CUDA --expt-extended-lambda --expt-relaxed-constexpr -Wno-deprecated-gpu-targets -std=c++20 ${YAKL_CUDA_FLAGS} ${YAKL_DEFINITIONS}")
    endif()
  ...
  set_source_files_properties(${files} PROPERTIES CXX_STANDARD 20)
  set_source_files_properties(${files} PROPERTIES LANGUAGE ${Kokkos_COMPILE_LANGUAGE})
endmacro(yakl_process_cxx_source_files)

macro(yakl_process_cuda_source_files files)
  yakl_set_definitions()
  set_source_files_properties(${files} PROPERTIES LANGUAGE ${Kokkos_COMPILE_LANGUAGE})
  if ("${YAKL_ARCH}" STREQUAL "CUDA")
      set_source_files_properties(${files} PROPERTIES LANGUAGE CUDA)
  ...
  set_source_files_properties(${files} PROPERTIES COMPILE_FLAGS "${YAKL_COMPILER_FLAGS}")
  set_source_files_properties(${files} PROPERTIES CXX_STANDARD 20)
endmacro(yakl_process_cuda_source_files)
...
macro(yakl_process_target tname)
  ...
  #   endif()
  #   set_target_properties(${tname} PROPERTIES CUDA_ARCHITECTURES ${Kokkos_CUDA_ARCHITECTURES})
